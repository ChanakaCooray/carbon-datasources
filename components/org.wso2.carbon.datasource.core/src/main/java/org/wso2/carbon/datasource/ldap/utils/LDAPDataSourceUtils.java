...
import org.wso2.carbon.datasource.ldap.LDAPConstants;
...
public class LDAPDataSourceUtils {
    ...
    public static LDAPDataSource buildConfiguration(String xmlConfiguration) throws DataSourceException {
        try {
            ...
            ldapDataSource.setUrlOfDns(config.getUrlOfDns());
            ldapDataSource.setDnsDomainName(config.getDnsDomainName());
